...
// Returns the public, no-login-required "view proposal" link
// (/proposal/view/[token]). New proposals already get a shareToken at
// creation time (mobile + web create routes), but this lazily generates
...
export async function GET(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    return successResponse({
      ...
      url: `${base}/proposal/view/${proposal.shareToken}`,
    })
  } catch (e: any) {
