...
export default function OverviewPage() {
  ...
  return (
    <div className="space-y-5">
      {/* Greeting hero */}
      <div className="rounded-2xl bg-gradient-to-br from-brand-600 to-brand-700 text-white p-6 relative overflow-hidden">
        ...
        <div className="relative">
          ...
          <p className="text-brand-100 text-sm mt-1">Here's what's happening with your account.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        {[
          { label: 'Active Services', value: activeServices, icon: Package, s: { chip: 'bg-brand-100 text-brand-600', val: 'text-brand-600' } },
      ...
      <div className="grid lg:grid-cols-3 gap-4">
        ...
        <div className="lg:col-span-2 bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          <div className="px-5 py-3.5 border-b border-gray-100 flex items-center justify-between">
            ...
            <Link href="/client-portal/invoices" className="text-xs text-brand-600 hover:underline flex items-center gap-0.5">View all <ArrowRight size={11} /></Link>
          </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
          ...
          {reportingPerson ? (
            <>
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-brand-500 to-brand-600 text-white flex items-center justify-center font-bold text-lg">
          ...
          <button onClick={() => setTicketModal(true)} className="w-full mt-4 border border-dashed border-gray-300 rounded-xl py-2.5 text-sm text-gray-600 hover:border-brand-400 hover:text-brand-600 flex items-center justify-center gap-1.5">
